...
class ProjectRepository:
    ...
    @staticmethod
    def create_project(conn: Any, project: Project) -> Project:
        sql = """
    ...
    @staticmethod
    def _row_to_model(row: Any) -> Project:
    ...
    @staticmethod
    def get_project(conn: Any, project_id: str) -> Optional[Project]:
    ...
    @staticmethod
    def list_projects(conn: Any, user_id: Optional[str] = None) -> List[Project]:
        if user_id:
    ...
    @staticmethod
    def update_project(conn: Any, project: Project) -> Optional[Project]:
        sql = """
            UPDATE projects
    ...
    @staticmethod
    def delete_project(conn: Any, project_id: str) -> bool:
