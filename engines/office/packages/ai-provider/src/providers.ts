...
export const AI_PROVIDERS: AiProviderMeta[] = [
  ...
  },
  {
    id: 'gemini',
    label: 'Gemini',
    // Restricted to Flash Lite models only for cost-efficient inference.
    models: [
...
const RETIRED_MODELS: Partial<Record<AiProviderId, Record<string, string>>> = {
  ...
  // entirely (405), verified 2026-08-31; gemini selections fall back to
  // flash-lite models for cost-efficient inference
  genspark: {
